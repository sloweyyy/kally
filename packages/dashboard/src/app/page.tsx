        ...
        <section className="mb-9">
          ...
          <div className="grid grid-cols-4 gap-3.5 max-md:grid-cols-2">
            {[
              ...
              { label: "Docs", title: "Confluence", sub: "PRD + Architecture", href: "https://example.atlassian.net/wiki/spaces/CST/pages/0000000000/Kally" },
              { label: "Product", title: "PRD v1", sub: "goals + rollout", href: "https://example.atlassian.net/wiki/spaces/CST/pages/0000000001" },
              { label: "Onboarding", title: "User Guide", sub: "for teammates", href: "https://example.atlassian.net/wiki/spaces/CST/pages/0000000002" },
            ].map((link) => (
