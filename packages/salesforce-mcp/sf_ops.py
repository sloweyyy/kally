...
Read usage:
  ...
  python3 scripts/sf_ops.py --mode on-hold --email thanh.pnguyen@katalon.com
  python3 scripts/sf_ops.py --mode on-hold --email thanh.pnguyen@katalon.com --output file
