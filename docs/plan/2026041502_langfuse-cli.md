...
| 9   | Eng   | \_\_schema special case                             | Mechanical     | P5        | Different syntax, needs explicit handling                                                                      | Treat like other resources               |
...
| Eng Review | `/plan-eng-review`   | Architecture & tests | 1    | clean            | 6 improvements applied (pin version, 1MB buffer, flag denylist, narrow allowlist, \_\_schema, --json) |
