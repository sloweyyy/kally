...
# --- Kally-only services (slack-mcp, salesforce-mcp, google-mcp, vault) ---
# These services exist on this fork but were removed upstream. They use the
# legacy `build` stage above for simplicity rather than per-package stages.
