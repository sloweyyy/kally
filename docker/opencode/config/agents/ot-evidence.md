...
Build URLs: `https://example.lightning.force.com/lightning/r/Case/{Id}/view`
...
Build URLs: `https://example.atlassian.net/browse/{KEY}`
...
Open tickets:
1. 00046068: https://example.lightning.force.com/lightning/r/Case/{Id}/view
2. 00040208: https://example.lightning.force.com/lightning/r/Case/{Id}/view

New tickets:
1. 00046570: https://example.lightning.force.com/lightning/r/Case/{Id}/view

Jira tickets:
1. KSR-10799: https://example.atlassian.net/browse/KSR-10799
```
